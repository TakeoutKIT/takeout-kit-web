<template>
    <div class="wrapKOPIPE">
        <div class="wrapHINAGATA">
            <h1>利用規約</h1>
            <p>この利用規約（以下，「本規約」といいます。）は，めしてく（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
            ...
            <ol>
            <li>このサイトの利用りおいて、料金はかかりません(ただし通信にかかる料金は利用者の負担となります)</li>
            </ol>
